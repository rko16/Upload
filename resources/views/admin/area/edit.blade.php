      ...
      <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap bg-white p-2 border">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
              ...
              <li class="breadcrumb-item">
                <a href="{{ route('admin.area.index') }}">City</a>
              </li>
...
<div class="row mb-4">
  <div class="col-lg-12">
    ...
    <form action="{{ route('admin.area.update', [$data->id]) }}" method="POST" enctype="multipart/form-data" id="form" >
      @csrf
      @method('PUT')
      <div class="row">
        <div class="col-sm-4 mb-3">
          <label class="font-size-13"><strong>Area Name</strong> <sub class="text-danger font-size-16">*</sub></label>
