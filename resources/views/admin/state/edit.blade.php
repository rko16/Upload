...
<div class="row mb-4">
  <div class="col-lg-12">
    ...
    <form action="{{ route('admin.state.update', [$state->id]) }}" method="POST" enctype="multipart/form-data" id="form" >
      @csrf
      @method('PUT')
      <div class="row">
        <div class="col-sm-4 mb-3">
          ...
          <input type="text" class="form-control" name="name" id="name" placeholder="Enter state name" value="{{$state->name}}">
        ...
        <div class="col-sm-4 mb-3">
          ...
          <input type="number" class="form-control" name="generation" id="generation" placeholder="Enter state generation" value="{{$state->generation}}">
          <div class="errorTxt"></div>
        </div>
      </div>
