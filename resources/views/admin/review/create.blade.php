                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.review.index') }}">Testimonial management</a>
                            </li>
    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <div class="card card-body p-4">
                <form action="{{ route('admin.review.store') }}" method="POST" enctype="multipart/form-data" id="form">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" name="name" placeholder="Enter the Description" class="form-control">
                            <div class="errorTxt"></div>
                        </div>
                        <div class="col-md-3 form-group">
                            <label for="type"><b>Rating</b></label>
                            <input type="number" name="rating" class="form-control" placeholder="Enter the Description" min="1" max="5" required>
                        </div>
                        <div class="col-md-3 form-group">
                            <label for="type"><b>Discription</b></label>
                            <input type="text" name="discription" class="form-control" placeholder="Enter the Description">
                        </div>
                    </div>
                    @if ($errors->any())
