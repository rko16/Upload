          ...
          <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap bg-white p-2 border">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
                  ...
                  <li class="breadcrumb-item">
                    <a href="{{ route('admin.inqueryAdmin.index') }}">inquery</a>
                  </li>
        ...
        <div class="card card-body p-4">
          ...
          <div class="row my-3 mt-4">
            <div class="col-sm-12 text-center">
              <button type="submit" class="btn btn-success py-2 px-3 ml-2"><span class="px-2 py-1 d-inline-block"><a href="{{ route('admin.inqueryAdmin.index') }}">Back</a></span></button>
            </div>
          </div>
        </div>
    </div>
