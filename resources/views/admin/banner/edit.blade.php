  ...
  <div class="row mb-4">
    <div class="col-lg-12">
      <div class="card card-body p-4">
        <form action="{{ route('admin.banner.update',[$banners->id]) }}" method="POST" enctype="multipart/form-data" id="form">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-sm-3 mb-3">
              ...
              <input type="file" class="form-control" name="upimage" id="name" placeholder="Enter image">
            </div>
            <!-- <div class="col-sm-3 mb-3">
              <label class="font-size-13" for="text">
                <strong>Banner image</strong><sub class="text-danger font-size-16">*</sub>
              </label>
              <input type="text" class="form-control" name="text" id="text" placeholder="Enter text" value="{{ $banners->text }}">
            ...
            <!-- <div class="col-sm-3 mb-3">
              ...
              <input type="text" class="form-control" name="url" placeholder="Enter url" value="{{ $banners->url }}">
              <div class="errorTxt"></div>
            </div> -->
            <!-- <div class="col-sm-3 mb-3">
              <label class="font-size-13" for="name">
              ...
              <input type="text" class="form-control" name="heading" placeholder="Enter heading" value="{{ $banners->heading }}">
              <div class="errorTxt"></div>
            </div> -->
          </div>
        ...
        <div class="row my-3 mt-4">
            <div class="col-sm-12 text-center">
              <img src="{{ asset($banners->image) }}" width="100%">
            </div>
          </div>
      </div>
    </div>
