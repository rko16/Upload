    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <div class="card card-body p-4">
                <form action="{{ route('admin.service.update',[$servicedata->id]) }}" method="POST" name="f3" id="f3"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="title" placeholder="Enter the Description" class="form-control" value="{{ $servicedata->title }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="content1" class="form-control" placeholder="Enter the Description" value="{{ $servicedata->content1 }}">
                            <div class="validation-error"></div>
                        </div>
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" placeholder="Enter the Description" name="heading" class="form-control" value="{{ $servicedata->heading }}">
                            <div class="validation-error"></div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="row">
                    <img src="{{ asset($servicedata->image) }}" style="margin-left: 12px;">
                </div>
            </div>
        </div>
    </div>
