            ...
            <div class="page-header border-0 pb-0 mb-0">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Quotation/Visit</li>
                    </ol>
                 </nav>
                <!-- <a href="{{ route('admin.quotationvisit.create') }}" class="btn btn-primary toolbar-item ml-auto">Add order</a> -->
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
  $(function () {
    var table = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('admin.quotationvisit.index') }}',
            type: 'GET'
        },
        columns: [
