          ...
          <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap bg-white p-2 border">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Add Project Managers</li>
                </ol>
              </nav>
          </div>
        </div>
    ...
    <div class="row mb-4">
      <div class="col-lg-12">
        <div class="card card-body p-4">
          <form form action="{{ route('admin.pm.store') }}" method="POST" enctype="multipart/form-data" id="form">
            @csrf
            <div class="row">
