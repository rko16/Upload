          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
              ...
              <li class="breadcrumb-item">
                <a href="{{ route('admin.askquestion.index') }}">FAQ</a>
              </li>
  ...
  <div class="row mb-4">
    <div class="col-lg-12">
      <div class="card card-body p-4">
        <form action="{{ route('admin.askquestion.update', [$faqdata->id]) }}" method="POST" enctype="multipart/form-data" id="form">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-sm-6 mb-3">
              <label class="font-size-13" for="name">
                <strong>Question</strong><sub class="text-danger font-size-16">*</sub>
              </label>
              <input type="text" class="form-control" name="question" value="{{$faqdata->question}}" id="question" placeholder="Enter question here">
              <div class="errorTxt"></div>
            </div>
            <div class="col-sm-6 mb-3">
              <label class="font-size-13" for="name">
                <strong>Answer</strong><sub class="text-danger font-size-16">*</sub>
              </label>
              <input type="text" class="form-control" name="answer" value="{{$faqdata->answer}}" id="answer" placeholder="Enter answer here">
              <div class="errorTxt"></div>
            </div>
          </div>
          <div class="row my-3 mt-4">
            <div class="col-sm-12 text-center">
              ...
              <a href="{{ route('admin.askquestion.index') }}">
