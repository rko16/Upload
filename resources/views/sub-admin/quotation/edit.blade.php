        ...
        <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap bg-white p-2 border">
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="{{ route('subadmin.quotationorder.index') }}">Quotation Order</a>
                </li>
    ...
    <div class="col-lg-12">
      <div class="card card-body p-4">
        @if ($errors->any())
          ...
          @endif
      <form action="{{ route('subadmin.quotationorder.update',[$orders->id]) }}" method="POST" enctype="multipart/form-data" id="form">
          @csrf
          @method('PUT')
          <div class="container">
               <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 mb-3">
                ...
                <input type="number" placeholder="Enter Electricity" name="generation" class="form-control" value="{{ $orders->generation }}">
              </div>
              <div class="col-sm-4 mb-3">
                <label class="font-size-13"><strong>Financial Savings</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="number" name="annualSavings" placeholder="Enter Savings" class="form-control" value="{{ $orders->annualSavings }}">
              </div>
            </div>
            <div class="container">
               <div class="row">
            ...
            <div class="row">
              <div class="col-sm-4 mb-3">
                ...
                <select class="form-control" name="structure">
                    <option value="1" @selected($orders->structure == '1')>Received</option>
                    <option value="0" @selected($orders->structure == '0')>Pending</option>
                </select>
              </div>
              ...
              <div class="col-sm-4 mb-3">
                ...
                <select class="form-control" name="balancesupply">
                    <option value="1" @selected($orders->balancesupply == '1')>Received</option>
                    <option value="0" @selected($orders->balancesupply == '0')>Pending</option>
                </select>
              </div>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                ...
                <input type="text" placeholder="Enter milestone" value="{{ $orders->milestone1 }}" name="milestone1" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" placeholder="Enter amount" name="amount1" value="{{ $orders->amount1 }}">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" placeholder="Enter link" value="{{ $orders->paymentlink1 }}" name="paymentlink1" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
               ...
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" name="amount2" value="{{ $orders->amount2 }}" placeholder="Enter amount">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->paymentlink2 }}" placeholder="Enter link" name="paymentlink2" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Status</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Milestone</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" placeholder="Enter milestone" value="{{ $orders->milestone3 }}" placeholder="Enter milestone" name="milestone3" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" name="amount3" value="{{ $orders->amount3 }}" placeholder="Enter amount">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->paymentlink3 }}" name="paymentlink3" placeholder="Enter link" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Status</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Milestone</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->milestone4 }}" placeholder="Enter milestone" placeholder="Enter milestone" name="milestone4" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" placeholder="Enter amount" class="form-control" name="amount4" value="{{ $orders->amount4 }}">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" placeholder="Enter link" value="{{ $orders->paymentlink4 }}" name="paymentlink4" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Status</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="col-sm-12 text-center">
              ...
              <a href="{{ route('subadmin.quotationorder.index') }}">
