...
<div class="content-wrapper">
        ...
        <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap bg-white p-2 border">
          <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-inverse-primary py-0 px-2 mb-0">
                ...
                <li class="breadcrumb-item">
                  <a href="{{ route('subadmin.cancel.index') }}">Quotation Order</a>
                </li>
  ...
  <div class="row mb-4">
    <div class="col-lg-12">
      ...
      <form action="{{ route('subadmin.cancel.update',[$orders->id]) }}" method="POST" enctype="multipart/form-data" id="form">
          @csrf
          @method('PUT')
          <div class="container">
               <div class="row">
            ...
            <div class="row">
              <div class="col-sm-4 mb-3">
                ...
                <input type="number" placeholder="Enter capacity KWp" value="{{ $orders->capacity }}" name="capacity" class="form-control">
              </div>

              <div class="col-sm-4 mb-3">
                <label class="font-size-13"><strong>Electricity Generated</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="number" name="generation" class="form-control" placeholder="Enter Electricity" value="{{ $orders->generation }}">
              </div>
              <div class="col-sm-4 mb-3">
            ...
            <div class="row">
              <div class="col-sm-4 mb-3">
                ...
                <input type="text" placeholder="Enter Proposal" value="{{ $orders->proposal }}" name="proposal" class="form-control">
              </div>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
               ...
               <div class="col-sm-3 mb-3">
                ...
                <input type="text" value="{{ $orders->paymentlink1 }}" name="paymentlink1" placeholder="Enter Link" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Milestone</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->milestone2 }}" placeholder="Enter Milestone" name="milestone2" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" placeholder="Enter Amount" class="form-control" name="amount2" value="{{ $orders->amount2 }}">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
               ...
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" placeholder="Enter Link" value="{{ $orders->paymentlink3 }}" name="paymentlink3" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Status</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Milestone</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->milestone4 }}" placeholder="Enter Milestone" name="milestone4" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" name="amount4" value="{{ $orders->amount4 }}" placeholder="Enter Amount">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->paymentlink4 }}" placeholder="Enter Link" name="paymentlink4" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Status</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="col-sm-12 text-center">
              ...
              <a href="{{ route('subadmin.cancel.index') }}">
