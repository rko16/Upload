          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                ...
                <input type="text" value="{{ $orders->milestone1 }}" name="milestone1" placeholder="Enter Milestone" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Milestone</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->milestone2 }}" name="milestone2" placeholder="Enter Milestone" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
