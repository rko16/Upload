          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 mb-3">
                ...
                <input type="number" name="annualSavings" class="form-control" placeholder="Enter Savings" value="{{ $orders->annualSavings }}">
              </div>
            </div>
            <div class="container">
               <div class="row">
            ...
            <div class="row">
              <div class="col-sm-6 mb-3">
                ...
                <input type="file" value="{{ $orders->surveyphoto }}" name="surveyphoto" class="form-control" placeholder="Enter Image">
              </div>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
               ...
               <div class="col-sm-3 mb-3">
                ...
                <input type="text" class="form-control" name="amount1" value="{{ $orders->amount1 }}" placeholder="Enter Amount">
              </div>
               <div class="col-sm-3 mb-3">
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
               ...
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" name="amount2" placeholder="Enter Amount" value="{{ $orders->amount2 }}">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Milestone</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" value="{{ $orders->milestone3 }}" placeholder="Enter Milestone" name="milestone3" class="form-control">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" placeholder="Enter Amount" name="amount3" value="{{ $orders->amount3 }}" >
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
            ...
            <div class="row">
              <div class="col-sm-3 mb-3">
               ...
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Amount</strong> <sub class="text-danger font-size-16">*</sub></label>
                <input type="text" class="form-control" placeholder="Enter Amount" name="amount4" value="{{ $orders->amount4 }}">
              </div>
               <div class="col-sm-3 mb-3">
                <label class="font-size-13"><strong>Payment Link</strong> <sub class="text-danger font-size-16">*</sub></label>
