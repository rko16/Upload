...
class QuotationController extends Controller
{
    ...
    //             ->addIndexColumn()
    //             ->addColumn('status', 'Visit done & Quote pending')
    //             ->addColumn('action', 'sub-admin.quotation.action')
    //             ->rawColumns(['action', 'status'])
    //             ->make(true);
    //     }
    //     return view('sub-admin.quotation.index');
    // }
    ...
    public function show($id)
    {
        ...
        return view('sub-admin.quotation.show', compact('orders', 'cities', 'states'));
    }
    ...
    {
        $orders = SolarInqury::where('id',$id)->with(['userdata'])->first();
        return view('sub-admin.quotation.edit', compact('orders'));
    }
    ...
    //     $order->save();
    //     if($order){
    //         return redirect()->route('subadmin.quotationorder.index')
