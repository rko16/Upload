(function($){
    ...
    $.fn.wizzy = function(options) {
        ...
        return this.each(function(){
            ...
            let btnNext = '<button class="btn btn-primary btn-submit btn-block" type="submit" data-action="next">Submit</button>';
            let btnBack = '<a href="#" class="btn btn-outline-primary btn-submit btn-block mr-2" data-action="back"> Back</a>';
            let btnFinish = '<a href="#thanksModal" data-bs-toggle="modal" class="btn btn-primary btn-submit btn-block ml3">Submit</a>';
